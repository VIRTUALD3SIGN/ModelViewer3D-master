...
/**
 * Created by Nikita on 12/5/2017.
 */

public class ArrayModel1 extends Model1 {
    ...
    public void draw(float[] viewMatrix, float[] projectionMatrix, @NonNull Light light) {
        ...
        Matrix.multiplyMM(mvMatrix1, 0, viewMatrix, 0, modelMatrix1, 0);
        Matrix.multiplyMM(mvpMatrix1, 0, projectionMatrix, 0, mvMatrix1, 0);
        GLES20.glUniformMatrix4fv(mvpMatrixHandle, 1, false, mvpMatrix1, 0);
