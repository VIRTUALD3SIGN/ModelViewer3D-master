...
public class ModelRenderer implements GLSurfaceView.Renderer {
    ...
    private static final float MODEL_BOUND_SIZE1 = 20f;
    ...
    public ModelRenderer(@Nullable Model model,Model1 model1,Model2 model2,Model3 model3) {
        this.model = model;
        this.model1 = model1;
        this.model2 = model2;
        this.model3 = model3;
    ...
    public void onDrawFrame(GL10 unused) {
        ...
        if (model != null) {
            ...
            Matrix.translateM(viewMatrix, 0, 0f, 0f, -20f); //
            model1.draw(viewMatrix, projectionMatrix, new Light(new float[] {0.0f, 0.0f, MODEL_BOUND_SIZE * 10, 1.0f}));

            Matrix.translateM(viewMatrix, 0, 0f, 0f, -20f); //
            model2.draw(viewMatrix, projectionMatrix, new Light(new float[] {0.0f, 0.0f, MODEL_BOUND_SIZE * 10, 1.0f}));

            Matrix.translateM(viewMatrix, 0, 0f, 0f, -20f); //
            model3.draw(viewMatrix, projectionMatrix, new Light(new float[] {0.0f, 0.0f, MODEL_BOUND_SIZE * 10, 1.0f}));
    ...
    public void onSurfaceCreated(GL10 unused, EGLConfig config) {
        ...
        if (model != null) {
            ...
            model1.init(MODEL_BOUND_SIZE1);
            floor.setOffsetY(model1.getFloorOffset());

            model2.init(MODEL_BOUND_SIZE1);
            floor.setOffsetY(model2.getFloorOffset());


            model3.init(MODEL_BOUND_SIZE1);
            floor.setOffsetY(model3.getFloorOffset());
