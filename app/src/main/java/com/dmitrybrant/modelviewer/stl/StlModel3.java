...
import com.dmitrybrant.modelviewer.ArrayModel3;
...
public class StlModel3  extends ArrayModel3 {
    private static int HEADER_SIZE = 80;

    public StlModel3(@NonNull InputStream inputStream) throws IOException {
        super();
    ...
    public void initModelMatrix2(float boundSize) {
        ...
        floorOffset3 = (minZ - centerMassZ3) / scale;
    }
    ...
    private void readText(@NonNull InputStream stream) throws IOException {
        ...
        this.centerMassX3 = (float)(centerMassX / vertexCount);
        this.centerMassY3 = (float)(centerMassY / vertexCount);
        this.centerMassZ3 = (float)(centerMassZ / vertexCount);
