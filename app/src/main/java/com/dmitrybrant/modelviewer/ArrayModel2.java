...
public class ArrayModel2 extends Model2 {
    ...
    public void draw(float[] viewMatrix, float[] projectionMatrix, @NonNull Light light) {
        ...
        Matrix.multiplyMM(mvMatrix2, 0, viewMatrix, 0, modelMatrix2, 0);
        Matrix.multiplyMM(mvpMatrix2, 0, projectionMatrix, 0, mvMatrix2, 0);
        GLES20.glUniformMatrix4fv(mvpMatrixHandle, 1, false, mvpMatrix2, 0);
