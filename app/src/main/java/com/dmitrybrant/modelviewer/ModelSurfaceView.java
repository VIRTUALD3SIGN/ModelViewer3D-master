...
public class ModelSurfaceView extends GLSurfaceView {
    ...
    public ModelSurfaceView(@NonNull Context context, @Nullable Model model, Model1 model1, Model2 model2, Model3 model3) {
        super(context);
        setEGLContextClientVersion(2);

        renderer = new ModelRenderer(model,model1,model2,model3);
