...
/**
 * Created by Nikita on 12/6/2017.
 */

public class ModelSurfaceView1 extends GLSurfaceView {
    private static final int TOUCH_NONE = 0;
    private static final int TOUCH_ROTATE = 1;
    private static final int TOUCH_ZOOM = 2;

    @NonNull
    private ModelRenderer1 renderer;
    ...
    public ModelSurfaceView1(@NonNull Context context) {
        super(context);
        setEGLContextClientVersion(2);

        renderer = new ModelRenderer1();
